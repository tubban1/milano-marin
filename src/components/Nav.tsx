    ...
    <nav className="nav-blur fixed top-0 left-0 w-full z-50 transition-all duration-500">
      <div className="max-w-7xl mx-auto px-8 py-5 flex justify-between items-center">
        <div className="flex gap-10 items-center">
          <a href="#home" className="group relative text-xs uppercase tracking-[0.3em] font-medium text-accent/70 hover:text-secondary transition-colors">
            Home
            <span className="absolute -bottom-1 left-0 w-0 h-[1px] bg-secondary transition-all group-hover:w-full"></span>
          </a>
          <a href="#menu" className="group relative text-xs uppercase tracking-[0.3em] font-medium text-accent/70 hover:text-secondary transition-colors">
            Menu
            <span className="absolute -bottom-1 left-0 w-0 h-[1px] bg-secondary transition-all group-hover:w-full"></span>
          </a>
          ...
          <a href="#contact" className="group relative text-xs uppercase tracking-[0.3em] font-medium text-accent/70 hover:text-secondary transition-colors">
            Contact
            <span className="absolute -bottom-1 left-0 w-0 h-[1px] bg-secondary transition-all group-hover:w-full"></span>
          </a>
        </div>
